...
SECRET_KEY = 'django-insecure-85gvsd84y2t8peo_d1+3ek#ucu0a$9ov*!w078vfc%b3f^s1pf'
...
MIDDLEWARE = [
    ...
    'users.middleware.DailyLifeResetMiddleware',
]
...
# Whitenoise configuration for caching static files in production
STORAGES = {
    "default": {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aptitudego.official@gmail.com'
